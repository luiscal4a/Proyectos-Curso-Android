...
public class TinyDB {
    ...
    public ArrayList<Contacto> getListContactos(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Contacto> objects =  new ArrayList<Contacto>();

        for(String jObjString : objStrings){
            Contacto value  = gson.fromJson(jObjString,  Contacto.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListContactos(String key, ArrayList<Contacto> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Contacto obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
